...
class ProductAdd extends React.Component {
    ...
    render() {
        const subHead = {'fontSize': 22,'marginBottom': 15, 'borderBottom':"1px solid black", padding: 4};
        const formFields = {width: "40%", float: "left", margin: 20};
        const pstyle= {padding:0,margin:0,'fontSize':'14pt'}
        const fieldWidth = {width:'55%'}
        const btnStyle = {'marginLeft': '20px', height: 30, 'marginTop': 10,width: 184,
           'fontWeight': 70,
